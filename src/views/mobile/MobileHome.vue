    ...
    <div class="m-card">
      ...
      <div class="m-grid-entry" style="padding: 0;">
        ...
        <div class="m-grid-item" @click="router.push('/m/units')">
          ...
          <span class="m-grid-text">住宿单位</span>
        </div>
        <div class="m-grid-item" @click="router.push('/m/tasks')">
        ...
        <div class="m-grid-item" @click="router.push('/m/profile')">
          <div class="m-grid-icon" style="background: #f0ecf9; color: #9b59b6;"><el-icon :size="22"><Setting /></el-icon></div>
          <span class="m-grid-text">系统设置</span>
        </div>
      </div>
    </div>
