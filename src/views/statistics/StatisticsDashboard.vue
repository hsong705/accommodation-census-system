    ...
    <el-tabs v-model="activeTab" class="stat-tabs">
      ...
      <el-tab-pane label="数据概览" name="overview">
        ...
        <el-row :gutter="16" style="margin-bottom: 20px;">
          ...
          <el-col :span="6">
            <KpiCard icon="TrendCharts" :value="data.avgOccupancyRate" label="平均入住率" color="#e6a23c" formatter="percent" />
          </el-col>
          <el-col :span="6">
            <KpiCard icon="Money" :value="data.avgAdr" label="平均房价(元)" color="#9b59b6" formatter="currency" />
          </el-col>
        </el-row>
      ...
      <el-tab-pane name="ranking">
        ...
        <el-alert
          title="排行榜基于当前权限范围内的住宿单位计算，价格/入住率仅统计正常营业的单位。"
          type="info"
          :closable="false"
          show-icon
        ...
        <el-row :gutter="16">
          <el-col :span="12" style="margin-bottom: 16px;">
            <TopRankingList title="平均房价 Top 5" :items="data.topByAdr" format="currency" unit="元/间夜" />
          </el-col>
          <el-col :span="12" style="margin-bottom: 16px;">
            <TopRankingList title="入住率 Top 5" :items="data.topByOccupancy" format="percent" />
          </el-col>
          <el-col :span="12" style="margin-bottom: 16px;">
